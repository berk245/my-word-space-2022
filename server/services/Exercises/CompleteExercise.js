...
const updateExerciseAndWordStats = async function({exerciseId, exerciseData}){
    ...
    await updateExerciseStatsAfterCompletion({exerciseId: exerciseId, correctCount: correctCount})
    return true
}
